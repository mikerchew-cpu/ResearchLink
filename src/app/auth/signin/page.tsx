          ...
          {!codeSent ? (
            <form onSubmit={handleSendCode}>
              <input
                ...
                style={{ width: "100%", padding: "10px 12px", border: "0.5px solid var(--color-border-secondary)", borderRadius: 10, fontSize: 16, marginBottom: 12, boxSizing: "border-box", textAlign: "center", color: "var(--color-text-primary)" }}
              />
            ...
            <form onSubmit={handleVerify}>
              ...
              <input
                ...
                placeholder="000000"
                maxLength={6}
                style={{ width: "100%", padding: "10px 12px", border: "0.5px solid var(--color-border-secondary)", borderRadius: 10, fontSize: 18, marginBottom: 12, textAlign: "center", letterSpacing: 8, boxSizing: "border-box", color: "var(--color-text-primary)" }}
              />
